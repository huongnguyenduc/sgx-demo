...
typedef struct ms_uppercase_string_t {
	sgx_status_t ms_retval;
	const uint8_t* ms_some_string;
	size_t ms_len;
	uint8_t* ms_result_string;
} ms_uppercase_string_t;
...
sgx_status_t uppercase_string(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* some_string, size_t len, uint8_t* result_string)
{
	sgx_status_t status;
	ms_uppercase_string_t ms;
	ms.ms_some_string = some_string;
	ms.ms_len = len;
	ms.ms_result_string = result_string;
